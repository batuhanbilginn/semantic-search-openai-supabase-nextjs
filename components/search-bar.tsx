...
const SearchBar = () => {
  ...
  return (
    <div className="flex items-center w-full gap-1 px-4 mt-4 border rounded-md group focus-within:border-neutral-400 bg-neutral-800 focus-within:outline-4 focus-within:outline-neutral-200 border-neutral-600">
